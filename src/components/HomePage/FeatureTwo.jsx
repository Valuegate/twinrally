    ...
    <div>
      <section className="bg-[#040E28] py-16 lg:py-24 text-white font">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          ...
          <div className="space-y-4 ">
            {accordionFeatures.map((feature, index) => (
              <motion.div
                ...
                className="bg-transparent text-white rounded-xl shadow-lg border border-slate-200 overflow-hidden font"
              >
                <button
                  onClick={() => toggleAccordion(index)}
                  className="w-full px-6 py-5 flex items-center justify-between transition-colors duration-200 cursor-pointer"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className=" font-semibold text-left font">{feature.title}</h3>
                  </div>
          ...
          >
            <div className="bg-transparent rounded-2xl border p-8 text-white">
              ...
              <Button className="bg-[#FBC2EB] text-white rounded-full hover:bg-gradient-to-r from-[#FBC2EB] to-[#A6C0EE] px-8 py-3 text-sm font-semibold">
                Start Your Journey
              </Button>
            </div>
          </motion.div>
