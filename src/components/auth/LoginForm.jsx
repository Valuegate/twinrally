            ...
            {socialProviders.map((provider) => {
              ...
              return (
                <Button
                  ...
                  className={`
                    w-full gap-3 py-6 font-semibold transition-all duration-300 hover:scale-105
                    ${provider.className}
                  `}
                >
                  {isLoading ? (
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between pt-2">
              <div className="flex items-center gap-3">
                ...
                >
                  {formData.rememberMe && (
                    <CheckCircle className="w-2.5 h-2.5 text-[color:var(--bg)]" />
                  )}
                </button>
              ...
              <button
                ...
                className="text-sm text-[color:var(--pink)] hover:underline hover:text-white transition-colors"
              >
                Forgot password?
              </button>
            </div>
            ...
            <LoginButton
              ...
              loading={loading}
              className="w-full py-4 mt-6 bg-gradient-to-r from-[color:var(--pink)] to-[color:var(--blue)] text-[color:var(--bg)] border-0 hover:scale-105 font-semibold"
            >
              {loading ? "Signing you in..." : "Sign In to TwinRally"}
            </LoginButton>
          </div>
        </>
      )}
