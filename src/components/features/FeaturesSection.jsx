      ...
      <div className="relative container mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed animate-slide-up-delay-1">
            ...
            comprehensive platform designed specifically for the twin community.
          </p>
        </div>
          ...
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={feature.title}
                className={`
                  group relative p-8 rounded-2xl backdrop-blur-lg border border-white/10
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div
                    className={`
                    inline-flex p-3 rounded-xl mb-6 backdrop-blur-sm border border-white/10
